...
// подключил как плагин для ssr, из коробки ssr пока не поддерживается, пришлось костылить
...
/*
Не относится напрямую к vue-medium-editor
https://github.com/nuxt/nuxt.js/issues/1700
https://github.com/nicolasbeauvais/vue-social-sharing/issues/26
