        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div v-else>
              ...
              <select-per-page v-model.number="selectedNumber"></select-per-page>
...
export default {
  name: "Users",
  components: { AppPagination, SelectPerPage, AtomSpinner },
  data() {
    return {
      currentPage: 1,
      selectedNumber: 5 // perPage на одной странице
      // перенёс в отдельный компонент SelectPerPage.vue
      // selectOptions: [
      //   { text: "2", value: 2 },
      //   { text: "5", value: 5 },
      //   { text: "10", value: 10 },
