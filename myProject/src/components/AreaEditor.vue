<template>
  <div>
    <div class="form-group"
      ...
      <!-- Валидация не имеет отношения к компоненту mediium-editor, это отдельный плагин -->
      <!-- Эту разметку мы переместили из родителя, чтобы она отображалась сразу под редактором -->
